...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#" data-toggle="modal" data-target="#filterData" class="d-inline d-sm-inline btn btn-sm btn-success shadow-sm"><i class="fas fa-calendar fa-sm text-white-50"></i> Filter Data</a>
    </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($log as $l) : ?>
                                <tr>
                                    ...
                                    <td><?= $l['access'] ?></td>
                                    <td><?= date('d F Y H:i:s', strtotime($l['waktu']))  ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
